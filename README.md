# i18next-to-fluent [![Build Status](https://travis-ci.org/artkravchenko/i18next-to-fluent.svg?branch=master)](https://travis-ci.org/artkravchenko/i18next-to-fluent)
